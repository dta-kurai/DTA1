...
import frc.robot.statesmachines.scoring.Bob;
...
public class Robot extends TimedRobot {
  ...
  public static TalonFX intakeMotor = new TalonFX(10);
  ...
  public void teleopInit() {
    Bob.enable();
    Bob.setCurrentState(frc.robot.statesmachines.scoring.Bob.idleState);
  }
